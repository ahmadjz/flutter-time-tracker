...
import 'package:time_tracker_null_safety/app/sign_in/email_sign_in_bloc.dart';
import 'package:time_tracker_null_safety/app/sign_in/email_sign_in_model.dart';
import 'package:time_tracker_null_safety/common_widgets/form_submit_button.dart';
...
class _EmailSignInFormBlocBasedState extends State<EmailSignInFormBlocBased> {
  ...
  List<Widget> _buildChildren(EmailSignInModel model) {
    return [
      ...
      SizedBox(height: 8.0),
      TextButton(
        child: Text(model.scondaryButtonText),
